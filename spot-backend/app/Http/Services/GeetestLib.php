...
class GeetestLib
{
    ...
    public function __construct($captcha_id, $private_key)
    {
        ...
        $this->domain = config('geetest.domain');
    }
     ...
     * @return int
     */
    public function pre_process($param, $new_captcha = 1): int
    {
     ...
     * @return mixed
     */
    public function get_response_str(): mixed
    {
     ...
     * @return int
     */
    public function success_validate($challenge, $validate, $seccode, $param, $json_format = 1): int
    {
     ...
     * @return mixed|string
     */
    private function send_request($url): mixed
    {
     ...
     * @return mixed|string
     */
    private function post_request($url, $postdata = ''): mixed
    {
        if (!$postdata) {
            return false;
        }
