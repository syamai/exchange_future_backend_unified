...
class DepositAlerts extends Mailable
{
    ...
    public function build()
    {
        ...
        $title = __('emails.deposit_alerts.title', [], $locale);
        ...
        return $this->view('emails.deposit_alerts')
            ...
            ->with([
                ...
                'date' => date('Y-m-d H:i:s', $this->transaction->created_at / 1000),
                'locale' => $locale,
