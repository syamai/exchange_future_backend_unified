...
class FutureOrderTakeProfit extends Mailable
{
    ...
    public function build()
    {
        ...
        $template = 'emails.future_order_trade_take_profit';
		$title = __('emails.future_order_trade_take_profit.title_create', ['APP_NAME' => config('app.name'), 'order_type' => $orderType], $locale);
