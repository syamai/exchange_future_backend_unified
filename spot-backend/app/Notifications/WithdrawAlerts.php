...
use App\Mail\WithdrawAlerts as WithdrawAlertsMail;
use Carbon\Carbon;

class WithdrawAlerts extends BaseNotification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable): WithdrawAlertsMail
    {
        $jsonData = null;
        try {
        ...
        return new WithdrawAlertsMail($jsonData, $this->currency);
    }
    ...
    private function getMessage($notifiable): string
    {
        ...
        return __('emails.withdraw_alerts.line_2', [], $locale)
