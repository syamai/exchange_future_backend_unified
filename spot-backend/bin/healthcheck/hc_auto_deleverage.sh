...
logfilename="MarginAutoDeleverage"
...
/usr/bin/aws cloudwatch put-metric-data --metric-name "${net}MarginAutoDeleverage" --dimensions InstanceId=$aws_instance  --namespace "MarginExchange" --value $max_interval
