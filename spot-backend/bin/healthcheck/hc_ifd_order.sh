...
/usr/bin/aws cloudwatch put-metric-data --metric-name "${net}${exchange}IFDOrder" --dimensions InstanceId=$aws_instance  --namespace "${exchange}Exchange" --value $max_interval
