...
/usr/bin/aws cloudwatch put-metric-data --metric-name "${net}MarginLiquidation" --dimensions InstanceId=$aws_instance  --namespace "MarginExchange" --value $max_interval
