...
logfilename="${exchange}StopOrder"
...
/usr/bin/aws cloudwatch put-metric-data --metric-name "${net}${exchange}StopOrder" --dimensions InstanceId=$aws_instance  --namespace "${exchange}Exchange" --value $max_interval
