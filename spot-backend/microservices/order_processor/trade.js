...
function startProcessor(currency, coin) {
    ...
    console.log('Start processor order trade currency: ' + currency + ', coin: ' + coin + ', currentTime: ' + currentTime);
    setTimeout(function () {
        runCommand(
            'php',
            ['artisan', 'order:process_trade', currency, coin],
            function () {
...
function startProcessorIfNeed(currency, coin, showError, startIfKeyNotFount) {
    var redisKey = 'process_order_me_trade_' + currency + '_' + coin;
