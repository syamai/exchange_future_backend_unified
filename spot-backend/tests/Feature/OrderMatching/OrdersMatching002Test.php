...
class OrdersMatching002Test extends OrdersMatchingTestBase
{
    protected $initData = [
        ...
        ['trade_type' => 'sell', 'currency' => 'usd', 'coin' => 'btc', 'type' => 'limit', 'fee' => '0', 'price' => '210000', 'quantity' => '20'],
