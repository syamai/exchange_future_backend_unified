...
class OrdersMatching008IOC7Test extends OrdersMatchingTestBase
{
    protected $initData = [
    ...
    protected $result = [
        ...
        // ['id' => 3, 'status' => Consts::ORDER_STATUS_EXECUTED, 'quantity' => 6, 'original_id' => 2],
        // ['id' => 4, 'status' => Consts::ORDER_STATUS_CANCELED, 'quantity' => 6, 'original_id' => 2],

        // ['id' => 5, 'status' => Consts::ORDER_STATUS_EXECUTED],
        // ['id' => 6, 'status' => Consts::ORDER_STATUS_EXECUTED],
        // ['id' => 7, 'status' => Consts::ORDER_STATUS_EXECUTED, 'quantity' => 6, 'original_id' => 6],
        // ['id' => 8, 'status' => Consts::ORDER_STATUS_CANCELED, 'quantity' => 6, 'original_id' => 6],
        // ['id' => 9, 'status' => Consts::ORDER_STATUS_PENDING],
    ];

    /**
     * @group orderMatching
     * @group orderMatchingIOC
     * @group orderMatching8IOC7
